...
$circleShadow: inset 5px 20px 40px rgba(#ff5d7b, 0.25),
    inset 5px 0px 5px rgba(#ff385c, 0.3),
    inset 5px 5px 20px rgba(#ff385c, 0.25),
...
.wrapper {
    ...
    background: linear-gradient(90deg, #fd6480 0%, #ffbbc8 47%, #fd6480 94%);
        ...
        .text {
            ...
            article {
                ...
                .button {
                    ...
                    border-radius: 50px;
                    cursor: pointer;
                    box-shadow: 0px 15px 20px #ff5d7b 50%;
                    z-index: 3;
                    color: $bg-01;
                    ...
                    &:hover {
                        box-shadow: 0px 10px 10px -10px #ff5d7b 50%;
...
<!-- 
Template (with some modifications) created by
